<?php 
	...
	class UsuariosModel extends Mysql
	{
		...
		public function selectUsuario(int $idpersona){
			...
			$sql = "SELECT p.idpersona,p.identificacion,p.nombres,p.apellidos,p.telefono,p.email_user,r.idrolusuario,r.nombrerolusuario,p.status, DATE_FORMAT(p.datecreated, '%d-%m-%Y | %h:%i:%s %p') as fechaRegistro 
					FROM persona p

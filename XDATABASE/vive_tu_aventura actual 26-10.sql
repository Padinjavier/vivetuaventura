...
-- Volcando estructura para tabla vivetuav_agencia.categoriapp
CREATE TABLE IF NOT EXISTS `categoriapp` (
...
-- Volcando datos para la tabla vivetuav_agencia.categoriapp: ~5 rows (aproximadamente)
DELETE FROM `categoriapp`;
INSERT INTO `categoriapp` (`idcategoria`, `nombre`, `descripcion`, `portada`, `datecreated`, `ruta`, `status`) VALUES
	(1, 'FFFF', 'El canotaje es una de las actividades al aire libre más tradicionales que se practica en el distrito de Lunahuaná.', 'img_57bfd177ac746208efa98657cec3970b copy.jpg', '2021-08-20 03:04:04', 'canotaje', 1),
...
CREATE TABLE IF NOT EXISTS `persona` (
  ...
  `img` varchar(100) COLLATE utf8mb4_swedish_ci DEFAULT NULL,
  `status` int NOT NULL DEFAULT '1',
...
INSERT INTO `recuerdos` (`idcategoria`, `nombre`, `descripcion`, `portada`, `datecreated`, `ruta`, `status`) VALUES
	(1, 'canotaje', 'El canotaje es una de las actividades al aire libre más tradicionales que se practica en el distrito de Lunahuaná.', 'img_5f570a72c6a3f2705cc3471b75022ccb.jpg', '2021-08-20 03:04:04', 'canotaje', 1),
	(2, 'Bebidas', 'Gaseosa, refresco, fresco o soda', 'img_90165900d66f0ad48275beb8fe1f3f14.jpg', '2021-08-21 00:47:10', 'bebidas', 1),
	(3, 'Dulces', 'Productos dulces peruanos', 'img_350eae9b69dd03a7713ebd84b9bcb5f7.jpg', '2023-11-08 22:52:36', 'dulces', 1),
...
INSERT INTO `servicio` (`idservicio`, `nombre`, `descripcion`, `precio`, `portada`, `datecreated`, `ruta`, `status`) VALUES
	(1, 'Rafting y nado con salvavidas en el río', 'Emocionante aventura acuática en aguas bravas con guías expertos y equipo de seguridad.', 12.00, 'img_78caeac00c1dbc023a5f6c14a1097a61.jpg', '2024-05-13 19:46:32', 'rafting-y-nado-con-salvavidas-en-el-rio', 1),
	(2, 'Práctica de kayak y canotaje', 'Explora ríos y lagos a bordo de kayaks y canoas, ideal para amantes de la naturaleza.', 9.00, 'img_153b54f2d49cb4b7938f04bad2983c3d.jpg', '2024-05-13 19:46:32', 'practica-de-kayak-y-canotaje', 1),
	(3, 'Tirolesa y parques de aventuras aéreas', 'Desafía la gravedad y disfruta de la adrenalina en recorridos por el aire entre árboles.', 5.00, 'img_2b1769b3c296dc978827a686bf4037a9.jpg', '2024-05-13 19:46:32', 'tirolesa-y-parques-de-aventuras-aereas', 1),
	(4, 'Tours extremos y de adrenalina', 'Experimenta emociones fuertes con actividades como rapel, bungee jumping y más.', 10.00, 'img_65cbe11d3cd4cbc84ab7a8e34c3367d3.jpg', '2024-05-13 19:46:32', 'tours-extremos-y-de-adrenalina', 1),
	(5, 'Tours de naturaleza y vida silvestre', 'Descubre la diversidad natural y observa animales en su hábitat natural.', 10.00, 'img_2511bcd62f49051305f870c1f1fe2ba1.jpg', '2024-05-13 19:46:32', 'tours-de-naturaleza-y-vida-silvestre', 1);

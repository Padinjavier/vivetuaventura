...
<html lang="es">
  ...
  <a class="app-sidebar__toggle text-dark" href="#" data-toggle="sidebar" aria-label="Hide Sidebar"> <i class="fas fa-bars"></i> </a>
  <!-- Navbar Right Menu-->
  <ul class="app-nav">
    <!-- User Menu-->
    <li class="dropdown">
      <a class="app-nav__item d-flex align-items-center justify-content-center p-0 m-0 " href="#" data-toggle="dropdown" aria-label="Open Profile Menu" style="width: 50px; height: 100%;">

...
<main class="app-content bg-white">
  ...
  <div class="row">
    ...
    <div class="col-12 ">
      <div class="mb-3 mr-4">
        <p class="">Nos alegra tenerte en nuestro sistema web de ventas. Gracias a tu experiencia y dedicación, juntos
          haremos realidad las aventuras de nuestros clientes.<br>
    ...
    width: 100px;">
        ...
        <style>
          .table-responsive::-webkit-scrollbar {
            ...
            /* Opcional: Fondo transparente para que no ocupe espacio */
          }
        </style>
      </div>

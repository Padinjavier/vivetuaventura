...
<main class="app-content" style="border: 1px solid red;">
  <div class="app-title">
    <div>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="tile">
        ...
        <?php } else {
          ...
          <section id="sPedido" class="invoice">
            <p class="page-header"><img src="<?= media(); ?>/tienda/images/logo.png"></p>

            <p class="text-right">Fecha: <?= $orden['fecha'] ?></p>
      ...
      <div class="">
        <div class="col-12 text-right"><a class="btn btn-primary" href="javascript:window.print('#sPedido');"><i

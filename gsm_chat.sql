...
-- Volcando datos para la tabla gsm.contacto: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla gsm.mensajes: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla gsm.post: ~10 rows (aproximadamente)

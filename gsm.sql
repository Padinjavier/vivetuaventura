...
-- Tiempo de generación: 07-03-2024 a las 02:08:44
...
ALTER TABLE `detalle_temp`
  ...
  ADD CONSTRAINT `FK_detalle_temp_persona` FOREIGN KEY (`personaid`) REFERENCES `persona` (`idpersona`);
...
ALTER TABLE `opciones`
  ADD CONSTRAINT `FK_opciones_persona` FOREIGN KEY (`personaid`) REFERENCES `persona` (`idpersona`);

--
-- Filtros para la tabla `pedido`
--
ALTER TABLE `pedido`
  ADD CONSTRAINT `FK_pedido_persona` FOREIGN KEY (`personaid`) REFERENCES `persona` (`idpersona`),
  ADD CONSTRAINT `FK_pedido_tipopago` FOREIGN KEY (`tipopagoid`) REFERENCES `tipopago` (`idtipopago`);
...
--
ALTER TABLE `persona`
  ADD CONSTRAINT `FK_persona_rol` FOREIGN KEY (`rolid`) REFERENCES `rol` (`idrol`);

--
-- Filtros para la tabla `producto`
--
ALTER TABLE `producto`
  ADD CONSTRAINT `FK_producto_categoria` FOREIGN KEY (`categoriaid`) REFERENCES `categoria` (`idcategoria`);

--
-- Filtros para la tabla `reembolso`
--
ALTER TABLE `reembolso`
  ADD CONSTRAINT `FK_reembolso_pedido` FOREIGN KEY (`pedidoid`) REFERENCES `pedido` (`idpedido`);
COMMIT;

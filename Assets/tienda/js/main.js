...
$(document).ready(function () {
  ...
  $(".main-menu li a").each(function () {
    var $this = $(this);
    // Obteniendo la parte de la ruta de la URL en el href del enlace
    var menuPath = new URL($this.attr("href"), window.location.origin).pathname;
    // console.log((i++));
    // console.log($this.attr('href'));
    // console.log(currentPath);
    // Comparar la parte de la ruta con la ruta actual
    if (menuPath === currentPath) {
      // Añadir la clase 'active-menu' y quitarla de los demás elementos
      $this
        .parent()

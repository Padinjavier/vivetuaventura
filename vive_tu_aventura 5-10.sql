...
-- Volcando estructura para tabla vivetuav_agencia.categoriaqq
CREATE TABLE IF NOT EXISTS `categoriaqq` (
...
-- Volcando datos para la tabla vivetuav_agencia.categoriaqq: ~5 rows (aproximadamente)
DELETE FROM `categoriaqq`;
INSERT INTO `categoriaqq` (`idcategoria`, `nombre`, `descripcion`, `portada`, `datecreated`, `ruta`, `status`) VALUES
